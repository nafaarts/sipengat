...
function Table({ data, jenis, dari_tanggal, sampai_tanggal }) {
                        ...
                        {isLoading ? (
                            ...
                            data?.data?.map((item, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-3">
                                        {moment(item.tanggal_masuk).format(
                                            "DD-MM-YYYY"
                                        )}
                                    </td>
                                </tr>
                            ...
                            data?.data?.map((item, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-3">
                                        {item.jumlah_keluar} {item.nama_satuan}
                                    </td>
                                    <td className="px-6 py-3">
                    ...
                    {data.links.map((item, index) => {
                        return (
                            <Link
                                href={item.url}
                                key={index}
                                className="px-3 py-1 text-white bg-orange-400 hover:bg-opacity-80 text-md"
                                preserveScroll
                                preserveState
                            >
                                <div
